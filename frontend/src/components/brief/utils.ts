...
export function briefToForm(b: Record<string, unknown>): FormState {
  ...
  return {
    ...
    adr: hotel.adr != null ? String(hotel.adr) : '',
    occupancy_rate: hotel.occupancy_rate != null ? String(hotel.occupancy_rate) : '',
    direct_pct: hotel.direct_pct != null ? String(hotel.direct_pct) : '',
    city: String(hotel.city || ''),
    booking_channels: String(hotel.booking_channels || ''),
    seasonality_summary: String(hotel.seasonality_summary || ''),
...
export function buildBrief(
  ...
  return {
    ...
    hotel_specifics: {
      ...
      direct_pct: form.direct_pct ? parseFloat(form.direct_pct) : null,
      location: {
